	    	...
	    	echo apply_filters(
	    		...
	    		sprintf('<div class="%1$s">%2$s</div>',
		    		...
		    		sprintf( '<p>%1$s %2$s %3$s</p>',
						    apply_filters( 'tc_copyright_link', sprintf( '&middot; <span class="tc-copyright-text">&copy; %1$s</span> <a href="%2$s" title="%3$s" rel="bookmark">%3$s</a>', esc_attr( date( 'Y' ) ), esc_url( home_url() ), strtoupper(esc_attr( get_bloginfo() ) ) )),
                            apply_filters( 'tc_credit_link', sprintf( '&middot; <span class="tc-credits-text"></span> %1$s MÉXICO &middot;', '' ) ),
                            apply_filters( 'tc_wp_powered', sprintf( '',
                              __('', ''),
                              __('', '')
                            ))
					)
