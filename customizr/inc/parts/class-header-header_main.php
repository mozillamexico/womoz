...
if ( ! class_exists( 'TC_header_main' ) ) :
    ...
    ****************************/
    ...
    function tc_set_header_hooks() {
      ...
      add_action ( '__header'         , array( $this , 'tc_tagline_display' ) , 30, 1 );
      add_action ( '__header'         , array( $this , 'tc_navbar_display' ) , 20 );
          		...
          		<div class="navbar-inner" role="navigation">
            		<div class="row-fluid">
              		<?php
                		do_action( '__navbar' , 'resp' ); //hook of social, menu, ordered by priorities 10, 20
              		?>
                   <a aria-label="Enlaces de Mozilla" target="_blanck" href="http://www.mozilla.org/" id="tabzilla2">Mozilla</a>
          			</div><!-- /.row-fluid -->
          		</div><!-- /.navbar-inner -->
        	</div><!-- /.navbar resp -->
      	</div><!-- /.navbar-wrapper -->
